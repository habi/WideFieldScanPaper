...
\begin{figure}%
	\centering
		\begin{tabular}{cc}
			\input{tikz-images/plots/DTF-Plots/edited-plot1}&
			\input{tikz-images/plots/DTF-Plots/edited-plot2}\\
			\input{tikz-images/plots/DTF-Plots/edited-plot3}&
			\input{tikz-images/plots/DTF-Plots/edited-plot4}
		\end{tabular}
