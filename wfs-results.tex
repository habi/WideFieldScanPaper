...
\todo{Sophies Lung-slab shown on Poster for Grad School Symposium (\ifhtml\else\url{\fi http://is.gd/5xhW4\ifhtml\else}\fi). Do we mention this 5-fold increase as a proof of concept? Or just leave it away? $\rightarrow$ MS \& JCS}%
