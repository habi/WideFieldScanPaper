...
%			\fbox{%
%				\includegraphics[width=\imsize]{img/widefieldscanning/R108C04C-overview-merge}%
				\begin{tikzpicture}[x=\imagescale,y=-\imagescale]
				\def\x{225}
				\def\y{625}
    				\node[anchor=north west,inner sep=0pt,outer sep=0pt] at (0,0)
...
%			\fbox{
%				\includegraphics[width=\imsize]{img/widefieldscanning/R108C04C-down-s2}%
				\begin{tikzpicture}[x=\imagescale,y=-\imagescale]
				\def\x{750}
				\def\y{725}
    				\node[anchor=north west,inner sep=0pt,outer sep=0pt] at (0,0)
...
%			\fbox{%
%				\includegraphics[width=\imsize]{img/widefieldscanning/R108C04C-down-merge}%
				\begin{tikzpicture}[x=\imagescale,y=-\imagescale]
				\def\x{775}
				\def\y{825}
    				\node[anchor=north west,inner sep=0pt,outer sep=0pt] at (0,0)
