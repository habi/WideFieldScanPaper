...
%				    % 458 px = 1.4336 mm > 100 px = 313 um > 160 px = 500 um
	...
	\todo[inline]{Do we need to add original slices to clearly show the increase in the FOV, or is this clear enough? Scale bars are not finalized, need to be adjusted to sensible lengths.}
\end{figure*}
...
\subsubsection{Comparison of protocols obtained with quality-guided protocl selection}
...
The two protocols shown in figure~\ref{fig:BvsT} are the two extremes of the 19 obtained protocols. The dataset shown on the left (B) has been reconstructed from 5244 merged projection images, the dataset shown on the right (T) has been reconstructed using only 874 merged slices. 
