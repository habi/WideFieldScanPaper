...
Figure~\ref{fig:NormalizedErrorPlot} confirms this finding. For a comparable total amount of recorded projections, the quality of the dataset with reduced projections is lower than when an equal amount of projections has been recorded for all three subscans\todo{compare O/P, M/N, I/J, E/H, C/D}.

\subsection{Three dimensional visualizations}
\subsubsection{Increasing the FOV}
\todo{Thoroughly discuss increase of FOV from $s_{2}$ to wfs}
...
Two exemplary visualizations of such segment extractions are shown in figure~\ref{fig:BvsT}\todo{explain these extractions in more details}\todo{discuss Felix' Idea with the SurfaceCharacteristics}.
...
%			\includegraphics[width=\imsize]{img/protocols/BvsT/detail-2-T}}
	\caption{Three dimensional view of volume renderings of terminal airway segments of two exemplary protocols, namely B and T.}
	\label{fig:BvsT}
