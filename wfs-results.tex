...
\begin{figure*}[htp]
	...
	\caption[Wide field scan method]{Wide field scan of a rat lung sample obtained from a Sprague-Dawley rat 21 days after birth, showing the distal-medial edge of the right lower lung lobe. The sample has been scanned at \SI{12.6}{\kilo\electronvolt}, the protocol details conform to protocol ``B'', described in table~\ref{tab:protocols}.}%
	\label{fig:wide field scan results}%
	\todo[inline]{this figure is much too big to fit on one page, but it's very hard to scale down. what can we do?}%
	\todo[inline]{!!!ALLL subsequent 3D-figures have ``strange'' scalebars on them. The long scalebars are there so YOU can control my work, the short scalebars are the correct ones!!!}%
\end{figure*}
\cbend
...
\begin{figure*}[htp]
	...
	\caption[Comparison of protocols B and T]{Comparison of protocols B and T. Top row: overview. Center row: view of the isosurfaces of the segmented airways. Bottom row: Slices}%
	\label{fig:BvsT}%
\end{figure*}
...
\begin{figure*}[htp]
	...
	\caption[Visualization of lung tissue slab.]{Visualization of lung tissue slab: %
