...
\begin{figure}
	\centering
		\caption{Plots of the mean SSIM parameter ($\pm$ Standard Deviation) for every 50\textsuperscript{th} slice for each of the protocols with artificially reduced central subscans}
	\ifiucr		
