...
%				    % 458 px = 1.4336 mm > 100 px = 313 um > 160 px = 500 um
	...
	\todo[inline]{Do we need to add original slices to clearly show the increase in the FOV, or is this clear enough? Scale bars for this and ALL subsequet images are not finalized, need to be adjusted to sensible lengths.}
\end{figure*}
