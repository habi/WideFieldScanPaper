...
\cbend%
\todo{do we need to show a closeup of the background to be able to see it?} %
\cbstart %
...
\begin{figure}[htp]
	...
	\subfloat[Volume Rendering of lung tissue slab, including two ROI]{%
		\begin{tikzpicture}[x=\imagescale,y=-\imagescale]
			...
			\def\y{450} % scalebar-y at 90% of height
			\node[anchor=north west,inner sep=0pt,outer sep=0pt] at (0,0)
				{\includegraphics[width=\imagewidth]{img/sophie/full}};
			% 1574px = 3.592mm > 100px = 228um > 219px = 500um
			\draw[|-|,thick] (19,318) -- (1571,58) node [sloped,midway,above] {\SI{3.592}{\milli\meter}};
