...
\ifiucr%%% iucr %%%
	\begin{figure}%
		...
		\begin{tikzpicture}[x=\imagescale,y=-\imagescale]
			...
			\draw[|-|,thick] (13,573) -- (1589,571) node [sloped,midway,above] {\SI{4.0138}{\milli\meter} (2712px)};
			% 1030px = 2.627mm > 100px = 255um > 196px = 500um
			\draw[|-|,thick] (357,337) -- (1380,451) node [white,sloped,midway,above] {\SI{2.627}{\milli\meter} (1775px)};
