...
\begin{figure}[htp]
	...
	\begin{tikzpicture}[x=\imagescale,y=-\imagescale]%
		\def\x{939}% scalebar-x at golden ratio
		\def\y{698}% scalebar-y at 90% of height
		\node[anchor=north west,inner sep=0pt,outer sep=0pt] at (0,0)%
			{\includegraphics[width=\imagewidth]{P:\#Docs\WideFieldScanPaper\img\widefieldscanning\R108C04C-skeleton-merge.png}};%
		% 714px = 4.0637mm > 100px = 569um > 88px = 500um
		\draw[|-|,thick] (6,516) -- (712,618) node [sloped,midway,above] {\SI{4.0637}{\milli\meter}};%
		\draw[|-|,thick] (\x,\y) -- (\x+88,\y) node [above] {\SI{500}{\micro\meter}};%
	\end{tikzpicture}%
