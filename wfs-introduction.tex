...
\todo[noline]{explain \unit{180}{\degree} vs. \unit{360}{\degree} setup}
...
Figure~\ref{fig:overlapping scans}\todo{Figure: Explaining the overlap?}depicts the details of the overlapping scans.
...
\begin{figure*}[tb] % or [p], if big
	\centering
	\begin{tikzpicture}
	 	%\draw[step=\e/4,color=gray] (0,0) grid (16\e,4\e);
		%\draw(0,0) grid (16\e,4\e);
		\draw                (0\e,0)  -- (4\e, 0) -- (4\e, 4\e) -- (0\e, 4\e) -- cycle;
