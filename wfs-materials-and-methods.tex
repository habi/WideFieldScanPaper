...
Figure \ref{fig:amount of projections} shows the process of merging three excemplary projections obtained from three subscans of a sample to one big projection covering the full FOV.\todo{3 subscan, different amount of projections, explain drawing a bit more...}

\begin{figure}
	\centering
	\input{tikz-images/amountofprojections}%
	\caption{Amount of Projections for a central- and a ring-scan. We assume that we have obtained 180 projections for the central scan and thus aquire two times 360 projections for the lateral scans. This enables us to stitch the projections $P_{1_{34}}$ (red line) from subscan 1 (red area), projection $P_{2_{17}}$ (green line) from the central subscan 2 (green area) and projection $P_{3_{394}}$ (blue line) of subscan 3 (blue area) to one big projection $P_{merge_{34}}$ which covers the full FOV.}%
	\todo[inline]{Do we only speak of central and ring-scan or from 3 subscans?}
