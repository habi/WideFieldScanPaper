...
\begin{figure*}
    ...
    (red line) from subscan 1 (red area), projection $P_{2_{142}}$ % XXX 17*1500/180 XXX
    (green line) from the central subscan 2 (green area) and projection $P_{3_{283}}$ % XXX 17*3000/180 XXX
    (blue line) of subscan 3 (blue area) to one big projection $P_{merge_{283}}$ % XXX 17*3000/180 XXX
