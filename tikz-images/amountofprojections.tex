...
%		\pattern [pattern=north east lines] (1,0) -- (3,0) arc (0:180:3*\radius) -- (-1,0) arc (180:0:\radius);
	%% Fill & Projection RingScan 1
...
%		\pattern [pattern=north west lines] (1,0) -- (3,0) arc (0:-180:3*\radius) -- (-1,0) arc (-180:0:\radius-\overlap);
	%% inner ring
		% ring
