...
\draw [] (axis cs:97.87,74.3991) -- (axis cs:100.87,74.3991) node [anchor=text] {\tiny C};
\draw [] (axis cs:97.87,70.4018) -- (axis cs:100.87,70.4018) node [anchor=text] {\tiny D};
\draw [] (axis cs:49.43,51.6990) -- (axis cs:52.43,51.6990) node [anchor=text] {\tiny M};
\draw [] (axis cs:49.46,41.5079) -- (axis cs:52.46,41.5079) node [anchor=text] {\tiny N};
