...
%			\node at (\BeamLength+0.5,\startAtY+1.25) {beam};
		...
		\pattern [pattern=checkerboard, pattern color=magenta, semitransparent] (0.5*\BeamLength+1,3) arc (90:-90:1.5) -- ++(0,1) arc (-90:90:0.5);
		\fill [color=cyan, semitransparent]  (0.5*\BeamLength+1,3+2) arc (90:270:1.5) -- ++(0,1) arc (270:90:0.5);
		\pattern [pattern=horizontal lines, pattern color=cyan] (0.5*\BeamLength+1,3+2) arc (90:270:1.5) -- ++(0,1) arc (270:90:0.5);
